...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expected result is incorrect. The second person should be Tim, not Bob.
    ...
    // Defect(s) Found: Expected result is incorrect. The first person should be Tim, not Sue.
